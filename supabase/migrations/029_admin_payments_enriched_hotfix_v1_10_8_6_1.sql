...
-- ============================================================
-- FIXIS PRO v1.10.8.6.1
-- MIGRATION 029
-- ADMIN PAYMENTS ENRICHED HOTFIX
-- ============================================================
-- Objetivo:
-- - Restaurar el contrato backend esperado por AdminPaymentsRepository.
-- - Exponer pagos enriquecidos SOLO a cuentas admin activas.
-- - Mantener toda mutacion financiera fuera de esta RPC.
-- - No modifica ledger, settlements, revised quotes ni payment evidence.
-- ============================================================
...
IS 'Admin-only read RPC for enriched payment rows used by FIXIS admin payment reconciliation UI.';
