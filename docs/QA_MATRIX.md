...
| Finance Regression | PENDING | Dos pagos conciliados; corte semanal en processing sin debito; 032 exige referencia de pago en UI y RPC, pendiente aplicar migracion y probar nueva compilacion; falta transferencia real y cierre paid |
