...
| Reseñas recibidas y textos de calificacion | PENDING | 2026-09-26: captura de iPhone 15 confirma en el detalle opinion enviada y recibida (5/5, comentarios y foto de Maria), sin cortes. Captura iPhone confirma historial recibido con nota, comentario y servicio; el usuario solicito identificar al autor. Migracion 035 habilita nombre/foto del autor con una sola RPC segura; 2026-09-26 QA de tercero devuelve true/true (identidad simulada, no ve reseña ajena). Falta confirmar los tres indicadores de privilegios del primer bloque, recompilar y validar autor con foto en iPhone/Android y vista cliente |
...
| Security Regression | PENDING | RLS activo en ocho tablas y permisos RPC correctos; simulaciones SQL de customer, professional y admin pasan. Aislamiento de identidad/calificaciones verificado por SQL (tres true) y entre cuentas reales: Jhony Torres no ve la calificacion de Maria Jose. Migracion 035: QA de reseñas recibidas con tercero simulado true/true; falta primer bloque de privilegios. Accesos reales reportados en cinco telefonos; falta evidencia fisica explicita de aislamiento entre cuentas para trabajos y pagos |
