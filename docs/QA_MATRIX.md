...
| Reseñas recibidas y textos de calificacion | PENDING | 2026-09-26: captura de iPhone 15 confirma en el detalle opinion enviada y recibida (5/5, comentarios y foto de Maria), sin cortes. Captura iPhone confirma historial recibido con nota, comentario y servicio; el usuario solicito identificar al autor. Migracion 035 y pantalla actualizadas para mostrar nombre/foto del autor con una sola RPC segura: falta aplicar migracion 035, ejecutar QA recibidas, recompilar y validar iPhone/Android y vista cliente |
