...
| Finance Regression | PENDING | Tras la transferencia: dos pagos paid, cada uno con una entrada profesional y una comision; faltan conciliar importes contra snapshots y probar settlement |
