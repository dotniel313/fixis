...
| Boton de calificacion y reputacion de cliente | PENDING | Cambio de boton a Ver mi calificacion tras enviar; reputacion visible junto al perfil cliente, promedio solo entre opiniones recibidas; faltan CI y prueba visual en dispositivos | 
