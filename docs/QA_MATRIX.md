...
| Security Regression | PENDING | RLS activo en ocho tablas y permisos RPC correctos; simulaciones SQL de customer, professional y admin pasan. Aislamiento de identidad/calificaciones verificado por SQL (tres true) y entre cuentas reales: Jhony Torres no ve la calificacion de Maria Jose. Migracion 035: permisos RPC true/true/true y aislamiento de tercero simulado true/true, confirmados el 2026-09-26. Accesos reales reportados en cinco telefonos; consultas del cliente ahora filtran tambien por client_id/customer_id. Pasos de QA en docs/QA_SECURITY_REAL_ACCOUNTS.md; falta compilar nueva version y evidencia fisica explicita de aislamiento entre cuentas para trabajos y pagos |
